...
export const CPU_DIRECTIVE_IDS = ["mn1610", "mn1613", "tms9995"] as const;
 ...
 * 先頭以外・不正値・重複・オペランド無しは無視して undefined。
 * @param sourceText アセンブラソース全文
 * @returns 有効な `.cpu` があればその ID
 */
export function scanSourceCpuId(sourceText: string): CpuDirectiveId | undefined {
