// Ported from test/tms9995/handshake/handshake_read_memory_test.ts.
...
fn ported_case_01_cdb() {
    super::assert_tms9995_symbols_have_code("test/tms9995/handshake/handshake_read_memory_test.ts", SYMBOLS);
}
